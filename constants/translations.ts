  ...
  en: {
    ...
    programs: {
      ...
      items: [
        {
          title: "Home Visits",
          description: "Regular companionship visits to ensure seniors feel connected, valued, and safe in their own homes."
        },
        {
          title: "Silver Socials",
          description: "Weekly coffee mornings and tea times organized to foster friendship and community among the elderly."
        },
        {
          title: "Music & Memory",
          description: "Therapeutic music sessions featuring classic hymns and songs to spark joy and aid memory retention."
        },
        {
          title: "Caregiver Support",
          description: "Providing respite, counseling, and spiritual support for family members caring for aging loved ones."
        },
        {
          title: "Wisdom Workshops",
          description: "Intergenerational events where seniors share life skills and stories with younger generations."
        },
        {
          title: "Spiritual Guidance",
          description: "Optional prayer groups, bible studies, and pastoral counseling for spiritual well-being."
        }
      ]
    },
    programsPage: {
  ...
  ko: {
    ...
    programs: {
      ...
      items: [
        {
          title: "가정 방문",
          description: "어르신들이 자신의 집에서 연결감과 소중함, 그리고 안전함을 느끼실 수 있도록 정기적으로 방문하여 말벗이 되어드립니다."
        },
        {
          title: "실버 소셜",
          description: "매주 열리는 커피 모임과 다과회를 통해 어르신들 간의 우정을 쌓고 공동체를 형성하도록 돕습니다."
        },
        {
          title: "음악과 추억",
          description: "찬송가와 고전 노래를 함께 부르며 기쁨을 나누고 기억력을 돕는 음악 치유 시간입니다."
        },
        {
          title: "보호자 지원",
          description: "연로하신 가족을 돌보는 보호자들을 위해 휴식, 상담, 그리고 영적 지지를 제공합니다."
        },
        {
          title: "지혜 나눔 교실",
          description: "어르신들이 삶의 지혜와 이야기를 다음 세대와 나누는 세대 통합 프로그램입니다."
        },
        {
          title: "영적 지도",
          description: "영적 안녕을 위한 선택적 기도 모임, 성경 공부, 그리고 목회 상담을 제공합니다."
        }
      ]
    },
    programsPage: {
